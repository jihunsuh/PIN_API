...
class AuthAndTokenApi(Resource):
    ...
    @basic_auth.login_required
    def post(self):
        return jsonify({'data': 'Hello, %s!' % g.user.id}, 200)
    ...
    def post(self):
        try:
            ...
            if get_id is None or get_password is None:
                return jsonify({'Exception': 'You should give us id and password'}, 400)
...
class PinApi(Resource):
    ...
    def post(self):
        try:
            ...
            if get_name is None or get_img_url is None:
                return jsonify({'Exception': 'You should give us name and img_url'}, 400)
    ...
    def put(self):
        try:
            ...
            get_board = request.args.get('board', 'default')
            if get_name is None or get_img_url is None:
                return jsonify({'Exception': 'You should give us name or img_url'}, 400)
    ...
    def post(self):
        try:
            ...
            if get_title is None or get_comment is None:
                return jsonify({'Exception': 'You should give us title and comment'}, 400)
    ...
    def delete(self):
        try:
            ...
            if board == 0:
                ...
                return jsonify({'Exception': 'You cannot delete default board'}, 400)
            return jsonify(board, 200)
        except Exception as e:
            return jsonify({'Exception': str(e)}, 409)
